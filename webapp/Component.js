...
sap.ui.define([
	...
	"ESM2/util/PLMModelManager",
	"ESM2/util/PLMODataManager",
	"ESM2/util/SaveHandler",
	"ESM2/util/Util"
], function (assert, UIComponent, JSONModel, ResourceModel, PLMModelManager, PLMODataManager, SaveHandler, Util) {
	"use strict";

	var Component = UIComponent.extend("ESM2.Component", {
		metadata: {
			manifest: "json",
		...
		init: function () {
			...
			var oRootPath = jQuery.sap.getModulePath("ESM2");
		...
		createUserModel: function(){
			var oModelusr = new JSONModel("/services/userapi/currentUser");
			return oModelusr;
		},
