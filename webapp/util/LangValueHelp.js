...
sap.ui.define([
	...
	var LangValueHelp = function (oComponent, otreenode, udtmod, oldudt, srcfield) {
		SpecDataTabBase.call(this, oComponent, "ESM2.frag.LangValueHelp");

		this._oComponent = oComponent;
		this._treenode = otreenode;
		this.patharr = [];
		this._oDialogadd = oComponent.getNavigator().createFragment("ESM2.frag.LangValueHelp", this); //FIXME:parentcontrol
		this._udtmod = udtmod;
		this._oldudt = oldudt;
