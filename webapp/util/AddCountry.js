...
sap.ui.define([
	...
	var AddCountry = function (oComponent, otreenode, udtmod, oldudt, cmbmod) {
		SpecDataTabBase.call(this, oComponent, "ESM2.frag.AddCountry");
		...
		this.patharr = [];
		this._oDialogadd = oComponent.getNavigator().createFragment("ESM2.frag.AddCountry", this); //FIXME:parentcontrol
		this._udtmod = udtmod;
		this._oldudt = oldudt;
		this._cmbmod = cmbmod;
