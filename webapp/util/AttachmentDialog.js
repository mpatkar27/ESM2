...
sap.ui.define([
	...
	var AttachmentDialog = function (oComponent, collection, attachtab) {
		SpecDataTabBase.call(this, oComponent, "ESM2.frag.AttachmentDialog");
		this._atttab= attachtab;
		this._oComponent = oComponent;
		this._collection = collection;
		this._oDialog = oComponent.getNavigator().createFragment("ESM2.frag.AttachmentDialog", this); //FIXME:parentcontrol
