...
sap.ui.define([
	...
	var MainSpecHelpGeneric = function (oComponent, srcfield, fldval) {
		SpecDataTabBase.call(this, oComponent, "ESM2.frag.MainSpecHelpGeneric");
		
		this._oComponent = oComponent;
		this.patharr = [];
		this._oDialogadd = oComponent.getNavigator().createFragment("ESM2.frag.MainSpecHelpGeneric", this); //FIXME:parentcontrol
		this._fldval = fldval;
	...
	MainSpecHelpGeneric.prototype = Object.create(SpecDataTabBase.prototype);
	MainSpecHelpGeneric.prototype.constructor = MainSpecHelpGeneric;

	MainSpecHelpGeneric.prototype._onCloseusag = function () {

		this._oDialogadd.control.close();

	};
	MainSpecHelpGeneric.prototype._onok = function (oEvent) {

		var selkey = oEvent.getSource().getSelectedKey();
		this._srcfield.setValue(selkey);
		this._oDialogadd.control.close();
	};
	MainSpecHelpGeneric.prototype._FetchhelpSuccess = function (aCharEntries) {
