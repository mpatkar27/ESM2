sap.ui.define([
	...
	var AdhocReport = function(oComponent, oParentControl) {
		// EXT_CLASS
		oComponent.initClassExtension(this, "ESM2.util.AdhocReport", arguments);

		this._oComponent = oComponent;

		// Construct dialog.

		this._oDialog = this._oComponent.getNavigator().createFragment("ESM2.frag.AdhocReport", this, oParentControl);
