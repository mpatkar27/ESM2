...
sap.ui.define([
	...
	"use strict";
		...
		SpecDataTabBase.call(this, oComponent, "ESM2.frag.UsageDiag");
		...
		this._oDialogadd = oComponent.getNavigator().createFragment("ESM2.frag.UsageDiag", this); //FIXME:parentcontrol
