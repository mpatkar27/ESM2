...
sap.ui.define([
	...
	var MultilevelAdd = function (oComponent, cPath, newMod, oldMod, cnode, obref, speckey, estcat) {
		SpecDataTabBase.call(this, oComponent, "ESM2.frag.MultilevelAdd");
		...
		this._oDialogadd = oComponent.getNavigator().createFragment("ESM2.frag.MultilevelAdd", this); //FIXME:parentcontrol
