...
sap.ui.define([
	...
	var SpecDataTabPropEdit = function (oComponent, bEditable) {
		SpecDataTabBase.call(this, oComponent, "ESM2.frag.SpecDataTabPropEdit");
	...
	SpecDataTabPropEdit.prototype = Object.create(SpecDataTabBase.prototype);
	SpecDataTabPropEdit.prototype.constructor = SpecDataTabPropEdit;

	SpecDataTabPropEdit.prototype.onBeforeShow = function () {
		// Remove all controls.
	...
	SpecDataTabPropEdit.prototype.addProp = function (sPropMode, oTreeNode, oInstanceInfo, oCollection, udtprop, secndrn, speckey, estcat,
