sap.ui.define([
	...
	var CharEditCommon = function(oComponent) {
		// EXT_CLASS
		oComponent.initClassExtension(this, "ESM2.util.CharEditCommon", arguments);

		this._oComponent = oComponent;
		
		// Construct dialog.

		this._oDialog = this._oComponent.getNavigator().createFragment("ESM2.frag.CharEditCommon", this);//FIXME:parentcontrol
