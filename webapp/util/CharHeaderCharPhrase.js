 ...
 sap.ui.define([
	...
	ModelManagerIntStatus,JSONModel) {
 	"use strict";
 	...
 	var CharHeaderCharPhrase = function (oComponent, oODataHeader) {
 		...
 		// EXT_CLASS
 		oComponent.initClassExtension(this, "ESM2.util.CharHeaderCharPhrase", arguments);
 	...
 	CharHeaderCharPhrase.prototype._getCharValueInputImpl = function (sEditableBindingPath, sCharValueBindingPath, compindref,
