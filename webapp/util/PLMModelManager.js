...
sap.ui.define([
	...
	"ESM2/util/ModelManager",
	"ESM2/util/ModelManagerConst",
	"ESM2/util/Util"
	...
	var PLMModelManager = function (oComponent) {
		...
		// EXT_CLASS
		oComponent.initClassExtension(this, "ESM2.util.PLMModelManager", arguments);
	...
	PLMModelManager.prototype._createFetchMultiCompositionBackendRequestObj = function (oInstanceKey, oAdditional, bFetch) {
		...
		if (aBackendRequests.length > 0) {
			...
			oBackendRequest.postProcess = function (oResponse) {
				...
				var oCompositionResponse1 = aResponses[iResponseIndex++].response;
				var oCompositionResponse = aResponses[iResponseIndex++].response;

				oInstanceAdditional.CompHeader = oCompositionResponse1;
				// EXT_HOOK: _extHookCreateFetchCompositionBackendRequestObjProcessResponse
				// Do custom response processing.
