...
sap.ui.define([
	...
	var CharEditUserDefinedText = function(oComponent) {
		// EXT_CLASS
		oComponent.initClassExtension(this, "ESM2.util.CharEditUserDefinedText", arguments);

		this._oComponent = oComponent;

		// Construct dialog.

		this._oDialog = this._oComponent.getNavigator().createFragment("ESM2.frag.CharEditUserDefinedText", this);//FIXME:parentcontrol
