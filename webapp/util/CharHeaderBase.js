...
sap.ui.define([
	...
	"sap/m/Button",
	"sap/m/Text",
	"ESM2/control/CharValueControl",
	"ESM2/control/ExpandVerticalLayout",
	"ESM2/control/Field",
	"ESM2/util/CharEditCommon",
	"ESM2/util/CharHeaderBaseConst",
	"ESM2/util/TableManagerConst"
	...
	var CharHeaderBase = function (oComponent, oODataHeader) {
		// EXT_CLASS
		oComponent.initClassExtension(this, "ESM2.util.CharHeaderBase", arguments);
		...
		this._mandatory = oODataHeader.MANDATORY;
	...
	CharHeaderBase.prototype.getControl = function (iCollapseLimit, fOnEdit, compindref, mandatoryfieldcounter) {
		...
		if (!this._bIsMultiValue) {
			...
			var oEditControl = this._getCharValueInput(sEditableBindingPath, this._sFieldName + "/0", compindref, mandatoryfieldcounter);
			var vEditMode = false;
	...
	CharHeaderBase.prototype._getCharValueInput = function (sEditableBindingPath, sCharValueBindingPath, compindref, mandatoryfieldcounter) {
		var oControl = this._getCharValueInputImpl(sEditableBindingPath, sCharValueBindingPath, compindref, mandatoryfieldcounter);
