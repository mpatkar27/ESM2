...
sap.ui.define([
	...
	"ESM2/control/AlwaysEnabled",
	"ESM2/control/Column",
	"ESM2/control/DestroyListener",
	...
	var TableManager = function(oComponent, oTable, oTemplate) {
		...
		assert(this._oTable.isA("ESM2.control.Table"), "oTable should be an instance of ESM2.control.Table");
	...
	TableManager.prototype._prepareControl = function(oControl) {
		...
		} else if (oControl.isA("ESM2.control.CharValueControl")) {
			this._prepareControl(oControl.getInnerControl());
			this._prepareControl(oControl.getEditButton());
		} else if (oControl.isA("ESM2.control.Field")) {
