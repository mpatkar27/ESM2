...
sap.ui.define([
	"sap/base/assert",
	"sap/ui/core/Control",
	"ESM2/control/TableConst"
], function(assert, Control, TableConst) {
	"use strict";

	var Table = Control.extend("ESM2.control.Table", {
		metadata: {
			properties: {
			...
			aggregations: {
				...
				columns: {type: "ESM2.control.Column", multiple: true, singularName: "column"},
				items: {type: "ESM2.control.ColumnListItem", multiple: true, singularName: "item", bindable: true}
			}
		},
